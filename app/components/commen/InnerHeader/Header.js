            ...
            <div className={Styles.header}> 
                <div className={Styles.container}> 
                    <div className={`${Styles.flex} ${Styles.homeheader}`}> 
                        ...
                        <div>
                            <a href="#"><img className={Styles.logoimage} src="/logo.png" alt="logo" /></a>
                        </div> 
                        ...
                        <div className={`${Styles.flex} ${Styles.colgp15} `}> 
                            ...
                            <div>
                                <img title="Menu" className={Styles.logoimage} src="/menu.svg" alt="user" onClick={() => menuClick()} />
                                <div id="menupopup" className={Styles.headermenu}>
                                    <button type="button" className={Styles.btncancel} onClick={() => menuClose()}>
                                        <img className={Styles.logoimage} src="/close.svg" alt="close" />
                                    </button>
                                    <div className={`${Styles.pd20} ${Styles.sidebarmenu} `}>
                                        ...
                                        <div className={`${Styles.clrgry} ${Styles.alignlft} ${Styles.pdTB20} ${Styles.menulist}`}><Link href="https://santander.learnondemand.co.uk/login/">Coaching</Link></div>
                                        ...
                                        <div className={`${Styles.clrgry} ${Styles.alignlft} ${Styles.pdTB20} ${Styles.menulist}`}>
                                            <button className={Styles.userGuideBtn} type='button' onClick={() => setShow(true)}>
                                                User guide
                                            </button>
                                        </div>
