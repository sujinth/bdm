                ...
                <Modal.Body className={Styles.modalbodywrap}> 
                    ...
                    <Row>
                        {popupContent.duelOption &&
                            <>
                                <Col><button type="button" className={Styles.modalbutton}>Yes</button> </Col>
                                <Col><button type="button" className={Styles.modalbutton} onClick={popupContent.onClick}>No</button></Col>
                            </>                          
                        }
                        {!popupContent.duelOption &&
                            <>
                                <Col><button type="button" className={Styles.modalOkButton} onClick={popupContent.onClick}>OK</button></Col>
                            </>                          
                        }
                    </Row>
                </Modal.Body>            
