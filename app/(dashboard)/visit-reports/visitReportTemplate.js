...
const VisitReportTemplate = ({ selectedData }) => {
  ...
  const [selectedExistingVisitReportData, setSelectedExistingVisitReportData] =
    useState({});
  ...
  const handleSubmit = async (e) => {
    e.preventDefault();
    let formInputValue =
      "txt1@@1,ta2@@,chk3@@1,chk3@@2,chk3@@3,rd4@@2,lst5@@1,lbl6@@1";
    ...
    if (formData?.flagTabbedView === "N") {
      ...
      txtDealershipNameElement =
        document.querySelector('input[name="txtDealershipName"]').value || "";
      lstDealershipStatus =
  ...
  async function getVisitReportList() {
    try {
      ...
      const response = await axios.post(`/api/visitReportsList`, {
        userId: userId,
      });
        ...
        <div className={Styles.visitnamebx}>
          ...
          <div className={Styles.listitems}>
            ...
            <ul className={`${Styles.listcntnt} ${Styles.listiconhide}`}>
              <li
                onClick={(e) => handleClickNewForm(e)}
                ref={liTagNewFormRef}
              ...
              {visitReportList?.map((item, index) => (
                <li
                  onClick={(e) => handleSelectExistingVisitReportData(e, item)}
                >
                    ...
                    <div className={`${Styles.flex} ${Styles.btnrow}`}>
                      ...
                      {formData.flagImage == "Y" && (
                        <div className={Styles.imageaddoption}>
                          ...
                          <div
                            id="addimagepopup"
                            className={Styles.addimagepopup}
                          >
                            <div
                              className={`${Styles.flex} ${Styles.imageoption}`}
                            >
