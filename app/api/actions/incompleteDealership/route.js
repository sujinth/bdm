...
export async function POST(request) {
    try {
        ...
        const response = await axios.post(`${config.INCOMPLETE_DEALERSHIP}?userid=${userId}&lastupdatedttm=${lastupdatedttm}`,
            {},
            {
                httpsAgent: agent
            }
        ...
        // Error case
        console.error("Error while fetching incomplete delearship reports:", error.message);
        return new Response(JSON.stringify(
