...
export async function POST(request) {
    try {
        ...
        const response = await axios.post(`${config.DELEARSHIP_VISIT_REPORTS}?userid=${userId}&lastupdatedttm=${lastupdatedttm}`,
            {},
            {
                httpsAgent: agent
            }
        ...
        // Error case
        console.error("Error while fetching delearship visit reports:", error.message);
        return new Response(JSON.stringify(
