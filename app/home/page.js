                                ...
                                <div>
                                    ...
                                    <Link href="/read-more">
                                        <div className={`${Styles.fntclrd} ${Styles.pdB10} ${Styles.fnt13}`}>
                                            <button className={`${Styles.fntclrd} ${Styles.readmorebtn}`}>[Tap to read more]</button>                   
                                        </div>
                                    </Link>
                        ...
                        <div className={`${Styles.flex} ${Styles.pdT50}  ${Styles.clgp20}`}>
                            ...
                            <div className={Styles.cntntbox}>
                                <Link href="/visit-reports">
                                    <div className={`${Styles.flex} ${Styles.brdradius} ${Styles.bgred}  ${Styles.clgp10}`}> 
                                        <div className={`${Styles.bgwht} ${Styles.iconbrborderradius} `}>
                                            <img className={`${Styles.pd10} ${Styles.borderdrk} ${Styles.iconbrborderradius}`} src="/report.svg" alt="report" />
                                        </div>
                                        <div className={`${Styles.whttxt} ${Styles.pd10} ${Styles.fntw600}`}>
                                            Visit Reports
                                        </div>
                                    </div>
                                </Link>
                            ...
                            <div className={Styles.cntntbox}>
                                <Link href="/actions">
                                    <div className={`${Styles.flex} ${Styles.brdradius} ${Styles.bgred}  ${Styles.clgp10}`}> 
                                        <div className={`${Styles.bgwht} ${Styles.iconbrborderradius} `}>
                                            <img className={`${Styles.pd10} ${Styles.borderdrk} ${Styles.iconbrborderradius}`} src="/action.svg" alt="Actions" />
                                        </div>
                                        <div className={`${Styles.whttxt} ${Styles.pd10} ${Styles.fntw600}`}>
                                            Actions
                                        </div>
                                ...
                                <div className={`${Styles.whtbg} ${Styles.brdgry} ${Styles.mrgT15} ${Styles.boxtxt} ${Styles.brdradius} ${Styles.pd10}`}>
                            ...
                            <div className={Styles.cntntbox}>
                                <Link href="https://santander.learnondemand.co.uk/login/">
                                    <div className={`${Styles.flex} ${Styles.brdgry} ${Styles.brdradius} ${Styles.bgred} ${Styles.clgp10}`}> 
                                        <div className={`${Styles.bgwht} ${Styles.iconbrborderradius} `}>
                                            <img className={`${Styles.pd10} ${Styles.borderdrk} ${Styles.iconbrborderradius}`} src="/communication.svg" alt="Coaching" />
                                        </div>
                                        <div className={`${Styles.whttxt} ${Styles.pd10} ${Styles.fntw600}`}>
                                            Coaching
                                        </div>
                            ...
                            <div className={Styles.cntntbox}>
                                <Link href="/resources">
                                    <div className={`${Styles.flex} ${Styles.brdgry} ${Styles.brdradius} ${Styles.bgred} ${Styles.clgp10}`}> 
                                        <div className={`${Styles.bgwht} ${Styles.iconbrborderradius} `}>
                                            <img className={`${Styles.pd10} ${Styles.borderdrk} ${Styles.iconbrborderradius}`} src="/resources.svg" alt="report" />
                                        </div>
                                        <div className={`${Styles.whttxt} ${Styles.pd10} ${Styles.fntw600}`}>
                                            Resources
                                        </div>
